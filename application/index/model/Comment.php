...
class Comment extends Model
{
    ...
    {
        $data = $this->alias('c')->field('c.com_id,c.com_content,m.mem_name,m.mem_img')->join('lt_member m','m.mem_id = c.com_userid')->where('com_artid',0)->limit(5)->order('com_id desc')->select();
        return $data;
    }
}