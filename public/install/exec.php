...
if(!$conn=@mysqli_connect($localhost,$user,$password)){
    ...
    $sql_query[] = [
        "sql"    =>  "INSERT INTO `lt_link` VALUES ('1', '冷月博客', 'loveteemo.com', '测试描述', '100', '1', '/favicon.ico');",
        "msg"    =>  "导入友情链接测试数据"
    ];
    ...
    $sql_query[] = [
        "sql"    =>  "INSERT INTO `lt_system` VALUES ('1', '冷月博客', '青春因为爱情而美丽', '青春,爱情,博客,thinkphp,bootstrap3', '青春因为爱情而美丽，欢迎来访~', '2013-12-31', '鄂ICP备15000791号-1', '© 2013 - 2016 冷月博客 & 版权所有 ', '<a href=\"http://loveteemo.com/admin.php\" target=\"_blank\">管理登陆</a>', '1', null, '3.0');",
        "msg"    =>  "导入系统设置表测试数据"
    ];
